...
function GuestViewList() {
  ...
  const handleNavigate = (startup) => {
    navigate('/GuestViewStartup', { state: { Startup :startup } })
  };
  /* OLD HTML */
  /*  <img 
          src={Revert} 
  ...
  return (
    <div className="App" style={{backgroundColor:"white"}}>
      ...
      <footer className="FooterNavBar">
        ...
        <img src={FooterRevert} alt="Footer" onClick={() =>navigate('/Guest')}/>
      </footer>
    </div>
